...
import "../../css/components/svgs/SillyProfessor.css"

function SillyProfessor(props) {
  return (
    <svg
      data-name="Layer 1"
    ...
    >
      ...
      {/* Eyes(inner) */}
      <circle cx={198.94} cy={138.98} r={5.45} fill="#fff"  className="left__eye"  />
      <circle cx={346.1} cy={138.98} r={5.45} fill="#fff" className="right__eye" />
      {/* specs(rings) */}
      <path
